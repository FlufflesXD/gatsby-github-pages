...
function useCastedRef(){return external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().useRef();}
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-portfolio-minimal/src/hooks/useOnScreen.tsx
// https://usehooks.com/useOnScreen/
function useOnScreen(ref,threshold=0.05){const{0:isIntersecting,1:setIntersecting}=(0,external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_.useState)(false);(0,external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_.useEffect)(()=>{const element=ref.current;const observer=new IntersectionObserver(([entry])=>{if(entry.isIntersecting){setIntersecting(true);observer.unobserve(entry.target);}},{threshold});if(element&&element instanceof Element)observer.observe(element);return()=>{if(element&&element instanceof Element)observer.unobserve(element);};},[ref,threshold]);return isIntersecting;}
...
function useSiteConfiguration(){const data=(0,gatsby_browser_entry.useStaticQuery)(query);return data.allSettingsJson.settings[0].siteConfiguration;}const query="948380417";
...
// Exports
var style_module_Logo = "style-module--Logo--c7351";

;// CONCATENATED MODULE: ./node_modules/gatsby-theme-portfolio-minimal/src/components/Logo/index.tsx
function Logo(props){var _props$theme;const{globalState}=(0,context/* useGlobalState */.j1)();const{logo}=useSiteConfiguration();const fontSize=props.fontSize||'2rem';const color=props.color||'var(--primary-color)';const Logo=getLogoContent(logo.image,logo.text);const LogoDark=getLogoContent(logo.imageDark,logo.text);const theme=(_props$theme=props.theme)!==null&&_props$theme!==void 0?_props$theme:globalState.theme;const ThemeSpecificLogo=theme===context/* Theme */.Q2.Dark?LogoDark||Logo:Logo;return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{className:style_module_Logo,"aria-roledescription":"logo",style:{fontSize,color}},ThemeSpecificLogo||logo.text);}const getLogoContent=(image,fallback)=>{var _image$svg,_image$svg2,_image$childImageShar;const hasImage=!!(image!==null&&image!==void 0&&image.childImageSharp)||!!(image!==null&&image!==void 0&&image.publicURL)||!!(image!==null&&image!==void 0&&(_image$svg=image.svg)!==null&&_image$svg!==void 0&&_image$svg.originalContent);const isSvg=(image===null||image===void 0?void 0:image.extension)==='svg';if(hasImage&&isSvg&&image!==null&&image!==void 0&&(_image$svg2=image.svg)!==null&&_image$svg2!==void 0&&_image$svg2.originalContent){return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{className:"logo-svg-wrapper",dangerouslySetInnerHTML:{__html:image===null||image===void 0?void 0:image.svg.originalContent}});}if(hasImage&&isSvg&&image!==null&&image!==void 0&&image.publicURL){return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("img",{src:image===null||image===void 0?void 0:image.publicURL,alt:fallback});}if(hasImage&&!isSvg&&image!==null&&image!==void 0&&(_image$childImageShar=image.childImageSharp)!==null&&_image$childImageShar!==void 0&&_image$childImageShar.gatsbyImageData){var _image$childImageShar2;return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{image:image===null||image===void 0?void 0:(_image$childImageShar2=image.childImageSharp)===null||_image$childImageShar2===void 0?void 0:_image$childImageShar2.gatsbyImageData,alt:fallback,objectFit:"contain"});}return undefined;};
...
function SplashScreen_SplashScreen(){const[shouldUnmount,setShouldUnmount]=external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().useState(false);const{dispatch}=(0,context/* useGlobalState */.j1)();return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{className:SplashScreen,type:shouldUnmount===false?'fadeIn':'fadeOut',duration:250,fillMode:"forwards",onAnimationEnd:()=>{if(shouldUnmount)dispatch({type:context/* ActionType */.Us.SetSplashScreenDone,value:true});}},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Helmet.Helmet,{bodyAttributes:{class:'fixed'}}),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{className:LogoWrapper},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{className:Backdrop,type:"reduceHeight",delay:800,fillMode:"forwards",onAnimationEnd:()=>{// Wait 500ms and start unmounting the splash screen
setTimeout(()=>{setShouldUnmount(true);},500);}}),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Logo,{fontSize:"3rem",color:"var(--background-color)",theme:context/* Theme */.Q2.Dark})));}
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-portfolio-minimal/src/utils/isExternalURL.ts
function isExternalURL(url){if(typeof window==='undefined')return false;return new URL(url,window.location.href).origin!==location.origin;}
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-portfolio-minimal/src/components/Link/index.tsx
// eslint-disable-next-line @typescript-eslint/no-unused-vars
function Link({to,children,ref,...rest}){if(!isExternalURL(to)&&rest.target!=='_blank'){return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,Object.assign({to:to},rest),children);}else{return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("a",Object.assign({},rest,{href:to,rel:"noopener noreferrer"}),children);}}
...
function Footer_Footer(){const{globalState}=(0,context/* useGlobalState */.j1)();const siteConfiguration=useSiteConfiguration();const darkModeEnabled=globalState.theme===context/* Theme */.Q2.Dark;return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("footer",{className:Footer,style:{background:darkModeEnabled?'var(--background-color)':'var(--primary-color)',borderTop:darkModeEnabled?'3px solid var(--box-shadow-hover-color)':undefined}},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{className:ContentWrapper},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Link,{to:"/","aria-label":"home"},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Logo,{fontSize:"1.5rem",color:darkModeEnabled?'var(--primary-color)':'var(--background-color)',theme:context/* Theme */.Q2.Dark})),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{className:Links},siteConfiguration.navigation.footer.map((linkObject,key)=>{return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Link,{key:key,to:linkObject.url,"aria-label":linkObject.label,style:{color:darkModeEnabled?'var(--primary-color)':'var(--background-color)'}},linkObject.label);}))));}
...
function Header_Header(){var _siteConfiguration$na,_siteConfiguration$na2;const[open,setOpen]=external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().useState(false);const siteConfiguration=useSiteConfiguration();const isDesktopBreakpoint=(0,useMediaQuery/* useMediaQuery */.a)('(min-width: 992px)');const navigationItems=/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement((external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default()).Fragment,null,siteConfiguration.navigation.header.map((linkObject,key)=>{return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Link,{key:key,to:linkObject.url,className:NavLink,onClick:!isDesktopBreakpoint?()=>setOpen(!open):undefined},linkObject.label);}),(_siteConfiguration$na=siteConfiguration.navigation.ctaButton)!==null&&_siteConfiguration$na!==void 0&&_siteConfiguration$na.url&&(_siteConfiguration$na2=siteConfiguration.navigation.ctaButton)!==null&&_siteConfiguration$na2!==void 0&&_siteConfiguration$na2.label?/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Link,{to:siteConfiguration.navigation.ctaButton.url,target:siteConfiguration.navigation.ctaButton.openNewTab?'_blank':undefined,className:CtaButton,onClick:!isDesktopBreakpoint?()=>setOpen(!open):undefined},siteConfiguration.navigation.ctaButton.label):null);const sideNavigationBar=/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement((external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default()).Fragment,null,/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{className:Burger,onClick:()=>setOpen(!open)},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{style:open?{transform:'rotate(45deg)'}:undefined}),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{style:open?{transform:'translateX(20px)',opacity:0}:undefined}),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{style:open?{transform:'rotate(-45deg)'}:undefined})),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{className:SideBarWrapper,style:open?{transform:'translateX(0)',visibility:'visible'}:undefined,"aria-hidden":!open,tabIndex:open?1:-1},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("nav",{className:SideNavigationBar},navigationItems)),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{className:SideBarBackdrop,style:open?{display:'block'}:undefined}));const topNavigationBar=/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("nav",{className:TopNavigationBar},navigationItems);return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("header",{className:Header},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Helmet.Helmet,{bodyAttributes:{class:open?Blurred:undefined}}),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{className:style_module_ContentWrapper,type:"fadeDown"},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Link,{to:"/","aria-label":"home"},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Logo,{fontSize:"2rem",color:"var(--primary-color"})),isDesktopBreakpoint?topNavigationBar:sideNavigationBar));}
...
function CookieBar_CookieBar(){const location=(0,index_modern.useLocation)();return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Animation/* Animation */.f,{className:CookieBar,type:"fadeUp",delay:1000},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement((build_default()),{cookieName:"gatsby-gdpr-google-analytics",buttonId:"confirm",buttonText:"Accept",declineButtonId:"decline",declineButtonText:"Decline",enableDeclineButton:true,disableStyles:true,onAccept:()=>(0,gatsby_plugin_gdpr_cookies/* initializeAndTrack */.v)(location)},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("p",null,"This website uses cookies \uD83C\uDF6A ")));}function EnsureActivatedTrackingCookie(){const location=(0,index_modern.useLocation)();external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().useEffect(()=>{const configured=api.get('portfolio-minimal-ga-configured');const enabled=api.get('gatsby-gdpr-google-analytics');if(configured!=='true')return;if(configured==='true'&&enabled==='true')return;try{api.set('gatsby-gdpr-google-analytics','true');(0,gatsby_plugin_gdpr_cookies/* initializeAndTrack */.v)(location);}catch{api.remove('gatsby-gdpr-google-analytics');console.warn('Could not initialize Google Analytics');}},[]);return null;}
...
function Layout_Layout(props){const location=(0,index_modern.useLocation)();const{globalState}=(0,context/* useGlobalState */.j1)();const{0:isInternalNavigation,1:setIsInternalNavigation}=(0,external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_.useState)(false);const showSplashScreen=!isInternalNavigation&&props.useSplashScreenAnimation&&!globalState.splashScreenDone;const darkModeEnabled=globalState.theme===context/* Theme */.Q2.Dark;(0,external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_.useLayoutEffect)(()=>{const referrer=location.state&&location.state.referrer!==null;setIsInternalNavigation(!!referrer);},[]);const splashScreenView=/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement((external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default()).Fragment,null,/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Helmet.Helmet,{bodyAttributes:{'data-theme':context/* Theme */.Q2.Light}}),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(SplashScreen_SplashScreen,null));const layoutView=/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement((external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default()).Fragment,null,/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Helmet.Helmet,{bodyAttributes:{'data-theme':darkModeEnabled?context/* Theme */.Q2.Dark:context/* Theme */.Q2.Light}}),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("div",{className:Layout},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Header_Header,null),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement("main",null,props.children),/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Footer_Footer,null),props.useCookieBar?/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(CookieBar_CookieBar,null):/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(EnsureActivatedTrackingCookie,null)));return showSplashScreen?splashScreenView:layoutView;}
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-portfolio-minimal/src/components/Page/index.tsx
function Page(props){const siteConfiguration=useSiteConfiguration();return/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(context/* GlobalStateProvider */.MC,{defaultTheme:siteConfiguration.featureToggles.useDarkModeAsDefault?context/* Theme */.Q2.Dark:context/* Theme */.Q2.Light,useDarkModeBasedOnUsersPreference:siteConfiguration.featureToggles.useDarkModeBasedOnUsersPreference,useSplashScreenAnimation:props.useSplashScreenAnimation||false},/*#__PURE__*/external_C_Users_Maks_Venne_Valley_East_Martial_Arts_Site_node_modules_react_index_js_default().createElement(Layout_Layout,{useSplashScreenAnimation:props.useSplashScreenAnimation||false,useCookieBar:siteConfiguration.featureToggles.useCookieBar},props.children));}
...
let Theme=/*#__PURE__*/function(Theme){Theme["Light"]="lightTheme";Theme["Dark"]="darkTheme";return Theme;}({});let ActionType=/*#__PURE__*/function(ActionType){ActionType["SetTheme"]="SET_THEME";ActionType["SetSplashScreenDone"]="SET_SPLASH_SCREEN_DONE";return ActionType;}({});const GlobalStateContext=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createContext(undefined);function GlobalStateProvider(props){const[globalState,dispatch]=react__WEBPACK_IMPORTED_MODULE_0___default().useReducer(globalStateReducer,{theme:initializeTheme(props.defaultTheme,props.useDarkModeBasedOnUsersPreference),// If useSplashScreenAnimation=false, we skip the animation by setting the initial value to true
...
function useSiteMetadata(){const data=(0,gatsby__WEBPACK_IMPORTED_MODULE_0__.useStaticQuery)(query);return data.allSettingsJson.settings[0].siteMetadata;}const query="3262260831";
...
!(function () {
  ...
  !(function () {
    ...
    const e = __webpack_require__(5950);
    var t = n.n(e),
      r = n(697),
      i = n.n(r),
      c = n(808),
